...
The YouTube Transcript Helper MVP has a few known limitations based on how YouTube manages transcripts and captions:
...
- **No Audio Transcription Yet:** True no-caption videos need future audio transcription support. This MVP does not include AI-based audio transcription, backend server processing, or audio-to-text generation.
